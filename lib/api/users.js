...
let MOCK_USERS = [
  ...
  { id: 'usr_002', name: 'Priya Patel', email: 'priya.patel@sridattam.com', role: 'read_only', createdAt: '2025-02-15T00:00:00Z' },
  { id: 'usr_003', name: 'Rahul Verma', email: 'rahul.verma@sridattam.com', role: 'read_only', createdAt: '2025-03-01T00:00:00Z' },
...
export async function updateUserRole(userId, newRole) {
  ...
  user.role = newRole === 'employee' ? 'read_only' : newRole;
