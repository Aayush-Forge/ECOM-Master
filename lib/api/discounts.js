...
export async function createDiscount(data, user = currentUser) {
...
export async function updateDiscount(id, data, user = currentUser) {
  requireRole('editor', user);
...
export async function deleteDiscount(id, user = currentUser) {
  requireRole('editor', user);
