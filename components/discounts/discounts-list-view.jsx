                  ...
                  <TableCell colSpan={6} className="py-12 text-center text-stone-500 font-inter">
                    <div className="flex flex-col items-center justify-center space-y-3">
                      ...
                      <Button asChild variant="outline" size="sm">
                        <Link href={`${basePath}/new`}>Create First Rule</Link>
                      </Button>
                    </div>
                  </TableCell>
                </TableRow>
        ...
        <AlertDialogContent className="bg-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="font-inter text-stone-600">
              Are you sure you want to delete discount rule <span className="font-semibold text-stone-900">&ldquo;{deleteTarget?.name}&rdquo;</span>? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
